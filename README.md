...
## Headless
### Description
In this assignment we had to take data from an accelerometer, then graph it on the OLED Screen. We then had to be able to remotely run the program; either by having the program run on start up or use SSH to run the program.
